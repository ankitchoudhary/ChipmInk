...
db.define_table('videos',
                Field('vid', length=20),
                Field('sourceOfVideo', length=100),
                Field('title', length=200),
                Field('description', length=2000),
                Field('total_view','integer'),
                Field('total_likes', 'integer'),
                Field('total_dislikes', 'integer'),
                Field('rating', 'double'),
                Field('tags', length=2000)
               # Field('subject', length=20,requires=IS_IN_SET(('english', 'philosophy', 'metaphysics'))),
               # Field('upload_date', 'datetime', default=request.now, writable=False)
                )
